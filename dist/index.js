    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (const [index, url] of urls.entries()) {
                ...
                fs_1.default.writeFileSync(`${path}/openapi-${index}.yaml`, data);
                config.inputs[index].inputFile = `openapi-${index}.yaml`;
            }
            fs_1.default.writeFileSync(`${path}/openapi-merge.json`, JSON.stringify(config, null, 2));
            child_process_1.execSync(`npx openapi-merge-cli --config ${path}/openapi-merge.json`);
            child_process_1.execSync('git clean -f');
            child_process_1.execSync(`git restore ${path}/openapi-merge.json`);
        }
        catch (error) {
